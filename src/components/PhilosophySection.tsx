  ...
  return (
    <section className="py-24 md:py-36 wash-terracotta">
      <div className="container max-w-3xl text-center">
        ...
        <p className="mt-8 font-body text-base text-foreground max-w-lg mx-auto leading-[1.85]">
          This work is not about adding more.
        </p>
        <p className="mt-3 font-display text-lg text-foreground italic max-w-lg mx-auto leading-relaxed">
